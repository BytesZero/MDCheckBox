package com.zsl.mdcheckbox;

/**
 * Created by zsl on 15/5/28.
 */
...
public class MDCheckBox extends View {
    ...
    private void showUnChecked() {
        ...
        va.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                float value = (float) animation.getAnimatedFraction(); // 0f ~ 1f
                radius = (int) ((1 - value) * height * 0.375f + height * 0.125f);
                if (value >= 1) {
                    isChecked = false;
                    isAnim = false;
                    if (listener != null) {
                        listener.onCheckedChanged(MDCheckBox.this, false);
                    }
                }
                invalidate();
            }
        ...
        va.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                if (value >= 1) {
                    ...
                    isAnim = false;
                    if (listener != null) {
                        listener.onCheckedChanged(MDCheckBox.this, true);
                    }
                    showCorrect();
                }
                invalidate();
